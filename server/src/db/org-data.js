...
export const UNITS = [
  { code: 'store_bajova', name: 'ТТ Бажова', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.bajova@bolashak.local', full_name: 'Финаев Иван', role: 'manager' } },
  { code: 'store_menovnoe', name: 'ТТ Меновное', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.menovnoe@bolashak.local', full_name: 'Заргумбаева Альфия', role: 'manager' } },
  { code: 'store_bolshenarym', name: 'ТТ Большенарым', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.bolshenarym@bolashak.local', full_name: 'Жиренчинов Даурен', role: 'manager' } },
  { code: 'store_orc', name: 'ТТ ОРЦ Алтай', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.orc@bolashak.local', full_name: 'Аскарова Алина', role: 'manager' } },
  { code: 'store_domino', name: 'ТТ Домино', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.domino@bolashak.local', full_name: 'Гусева Майя', role: 'manager' } },
  { code: 'store_shemonaiha', name: 'Магазин Шемонайха', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168, is_active: 0,
    manager: { email: 'mgr.shemonaiha@bolashak.local', full_name: 'Руководитель Шемонайха', role: 'manager' } },
  { code: 'store_kalbatau', name: 'партнер Калбатау', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.kalbatau@bolashak.local', full_name: 'Руководитель Калбатау', role: 'manager' } },
  { code: 'store_glubokoe', name: 'партнер Глубокое', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.glubokoe@bolashak.local', full_name: 'Руководитель Глубокое', role: 'manager' } },
  { code: 'store_zelenyi', name: 'Магазин Зеленый', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168, is_active: 0,
    manager: { email: 'mgr.zelenyi@bolashak.local', full_name: 'Руководитель Зеленый', role: 'manager' } },
  { code: 'store_innarus', name: 'ТТ Иннарус', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.innarus@bolashak.local', full_name: 'Саркисова Мила', role: 'manager' } },
  { code: 'store_samarskoe', name: 'партнер Самарское', unit_type: 'store', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'mgr.samarskoe@bolashak.local', full_name: 'Руководитель Самарское', role: 'manager' } },
  { code: 'rc_ust', name: 'РЦ и логистика', unit_type: 'warehouse', schedule_type: 'shift_mixed', hours_norm_default: 176,
    manager: { email: 'aisana@bolashak.local', full_name: 'Жумагулова Айсана', role: 'manager' } },
  { code: 'office_aup', name: 'АУП', unit_type: 'office', schedule_type: 'standard_5_2', hours_norm_default: 160,
    manager: { email: 'aizada@bolashak.local', full_name: 'Мейрманова Айзада', role: 'admin' } },
  { code: 'office_marketing', name: 'Отдел маркетинга', unit_type: 'office', schedule_type: 'standard_5_2', hours_norm_default: 160,
    manager: { email: 'diana@bolashak.local', full_name: 'Халелова Диана', role: 'manager' } },
  { code: 'office_commercial', name: 'Коммерческий отдел', unit_type: 'office', schedule_type: 'standard_5_2', hours_norm_default: 160,
    manager: { email: 'mgr.commercial@bolashak.local', full_name: 'Шаниязова Раушан', role: 'manager' } },
  { code: 'office_hr', name: 'HR-отдел', unit_type: 'office', schedule_type: 'standard_5_2', hours_norm_default: 160,
    manager: { email: 'talshyn@bolashak.local', full_name: 'Нагашыбаева Талшын', role: 'hr' } },
  { code: 'office_fin', name: 'Бухгалтерия', unit_type: 'office', schedule_type: 'standard_5_2', hours_norm_default: 160,
    manager: { email: 'galina@bolashak.local', full_name: 'Колотова Галина', role: 'finance' } },
  { code: 'it', name: 'IT-отдел', unit_type: 'office', schedule_type: 'flexible', hours_norm_default: 160,
    manager: { email: 'alihan@bolashak.local', full_name: 'Акрамханов Алихан', role: 'manager' } },
  { code: 'security', name: 'Служба безопасности', unit_type: 'security', schedule_type: 'shift', hours_norm_default: 168,
    manager: { email: 'ernar@bolashak.local', full_name: 'Унарбеков Ернар', role: 'manager' } },
];

export const USERS = [
  { email: 'aizada@bolashak.local', full_name: 'Мейрманова Айзада', role: 'admin', password: 'admin123', unit_code: 'office_aup' },
  { email: 'talshyn@bolashak.local', full_name: 'Нагашыбаева Талшын', role: 'hr', password: 'hr123', unit_code: 'office_hr' },
  { email: 'galina@bolashak.local', full_name: 'Колотова Галина', role: 'finance', password: 'fin123', unit_code: 'office_fin' },
